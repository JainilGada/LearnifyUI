              ...
              children: [
                ...
                ClipRRect(
                  ...
                  child: LinearProgressIndicator(
                    ...
                    valueColor:
                        AlwaysStoppedAnimation<Color>(Color(0xFF4F9DDE)),
                    minHeight: 8,
                  ),
                ),
              ],
...
class _QuizScreenState extends State<QuizScreen> {
  ...
  final List<Map<String, dynamic>> questions = [
    {
      'question':
          'What percentage should you allocate for needs in the 50/30/20 rule?',
      'options': ['30%', '50%', '20%', '40%'],
      'correctAnswer': 1,
      'xpReward': 10,
    },
  ...
  Widget _buildOptionButton(int index, String text, int correctAnswer) {
    ...
    if (!isAnswered) {
      backgroundColor =
          selectedAnswer == index ? Color(0xFF4F9DDE) : Colors.white;
      borderColor =
          selectedAnswer == index ? Color(0xFF4F9DDE) : Colors.black12;
    } else {
...
class LessonCompleteScreen extends StatelessWidget {
  ...
  const LessonCompleteScreen({Key? key, required this.xpEarned})
      : super(key: key);
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          GridView.count(
                            ...
                            children: [
                              _buildWeekStat(
                                  '47', 'Minutes learned', Color(0xFF4F9DDE)),
                              _buildWeekStat(
                                  '85%', 'Quiz accuracy', Color(0xFF9B5DE5)),
                              _buildWeekStat(
                                  '3', 'Lessons completed', Color(0xFF10B981)),
                              _buildWeekStat(
                                  '5', 'Days active', Color(0xFFFF6B6B)),
                            ],
                          ),
                        ],
                      ),
